...
Подходит для локальных API вроде [OBS Stream Widget Statistics v2](https://github.com/ARTJ1/OBS-Stream-Widget-Statistics-v2/releases) (`http://127.0.0.1:19123/api/...`). [пак кнопок для этого виджета](https://github.com/ARTJ1/OBS-Stream-Widget-Statistics-v2/releases/tag/streamdock-icons-v1.0.0)
